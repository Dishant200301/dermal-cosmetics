...
const RotatingBadge = () => (
  <div className="absolute left-8 top-[60%] -translate-y-1/2 hidden lg:block">
...
export const Hero = () => {
  return (
    <section className="bg-[#f7f0f2] px-4 lg:px-8 xl:px-4 py-2 ">
        ...
        <div className=" bg-deep-green-800 rounded-30  relative">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="p-8 lg:p-12 xl:p-24 flex flex-col justify-center">
              <h1 className="font-heading text-3xl md:text-5xl xl:text-[56px] text-white leading-tight tracking-wide mb-6">
                Comprehensive care for your skin's health and beauty
              </h1>
              <p className="font-body text-md text-white/90 mb-8 max-w-lg">
              ...
              <Link to="/services" className="btn-secondary w-fit mb-10">
                View Our Services
                <ArrowIcon className='w-4 h-4 text-[#1C4942]' />
              </Link>
            ...
            {/* Right Image */}
            <div className="relative h-[400px] md:h-auto lg:h-auto">
              <img
                src={heroModel}
